<x-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="rounded-lg shadow-md bg-white p-3">
                ...
                <div class="p-4">
                    ...
                    <ul class="my-4 bg-gray-100 p-4">
                        ...
                        <li class="mb-2">
                            <strong>Remote:</strong> {{ $job->remote_work ? 'yes' : 'no' }}
                        </li>
                        <li class="mb-2">
                        ...
                        <div x-cloak x-show="open"
                            ...
                            <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                                ...
                                <form method="POST" action="{{ route('applicant.store', $job->id) }}"
                                    ...
                                    <x-inputs.file id="resume_path" name="resume_path" label="Upload Your Resume .(pdf)"
                                        :required="true" />

                                    <button type="submit"
                                        class="bg-blue-500 hover:bg-blue-600 text-white px-4 p-2 rounded-md">
                                        Submit Application
                                    </button>

                                    <button @click="open=false"
                                        class="bg-gray-300 hover:bg-gray-400 text-black px-4 p-2 rounded-md">
                                        Cancel
                                    </button>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            @guest
                <p class="mt-10 bg-gray-200 text-gray-500 font-bold w-full py-2 px-5 rounded-full text-center">
                    <i class="fas fa-info-circle mr-3">
                    </i>You must be logged in to bookmark a job
                </p>
            @else
                <form method="POST"
