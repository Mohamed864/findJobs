<x-layout>
    <section class="flex flex-col md:flex-row gap-4">
        {{-- Profile Info Form --}}
        <div class="bd-white p-8 rounded-lg shadow-md w-full">
        ...
        <div class="bd-white p-8 rounded-lg shadow-md w-full">
            ...
            @forelse($jobs as $job)
                <div class="flex justify-between item-center border-b-2 border-gray-2 py-2">
                    <div>
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('jobs.edit', $job->id) }}"
                            class="px-4 py-2 h-9 bg-blue-500 hover:bg-blue-600 text-white rounded text-sm">Edit</a>
                        <!-- Delete Form -->
